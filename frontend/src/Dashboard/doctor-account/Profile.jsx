...
//exp
  ...
  return (
    <div>
        <h2 className='text-headingColor font-bold text-[24] leading-9 mb-10'>
            Profile Information
            </h2>
                    ...
                    <div key={index}>
                        <div>
                           ...
                           <div className="grid grid-cols-2 gap-5 mt-5">
                            ...
                            <button onClick={e=>deleteExperience(e,index)} className='bg-red-600 p-2 
                            rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer'>
                                <AiOutlineDelete />
                                </button>        
                        </div>
                    </div>
